...
RECTANGLE_TRACK_PRINT_INTERVAL = 10
RECTANGLE_TRACK_GC_INTERVAL = 60
RECTANGLE_TRACK_CENTER_CROSS_SIZE = 12

# 历史参数别名：旧代码仍可读取 TANGLE_ 前缀。
TANGLE_PRINT_INTERVAL = RECTANGLE_TRACK_PRINT_INTERVAL
TANGLE_GC_INTERVAL = RECTANGLE_TRACK_GC_INTERVAL
TANGLE_CENTER_CROSS_SIZE = RECTANGLE_TRACK_CENTER_CROSS_SIZE


# ------------------------------------------------------------
# 方框四角循环应用（rectangle_corner_cycle.py）
# ------------------------------------------------------------

RECTANGLE_CORNER_CYCLE_HOLD_MS = 3000
RECTANGLE_CORNER_CYCLE_MOVE_MS = 3000
RECTANGLE_CORNER_CYCLE_UART_SEND_PERIOD_MS = UART_SEND_PERIOD_MS
RECTANGLE_CORNER_CYCLE_PRINT_INTERVAL = 30
RECTANGLE_CORNER_CYCLE_GC_INTERVAL = 60
RECTANGLE_CORNER_CYCLE_NAMES = ("TL", "TR", "BR", "BL")
...
RECTANGLE_CORNER_CYCLE_OUTLINE_COLOR = (0, 255, 0)
RECTANGLE_CORNER_CYCLE_ACTIVE_COLOR = (255, 255, 0)
RECTANGLE_CORNER_CYCLE_CENTER_COLOR = (255, 255, 255)

# 历史参数别名：旧代码仍可读取 CORNER_CYCLE_ 前缀。
CORNER_CYCLE_HOLD_MS = RECTANGLE_CORNER_CYCLE_HOLD_MS
CORNER_CYCLE_MOVE_MS = RECTANGLE_CORNER_CYCLE_MOVE_MS
CORNER_CYCLE_UART_SEND_PERIOD_MS = RECTANGLE_CORNER_CYCLE_UART_SEND_PERIOD_MS
CORNER_CYCLE_PRINT_INTERVAL = RECTANGLE_CORNER_CYCLE_PRINT_INTERVAL
CORNER_CYCLE_GC_INTERVAL = RECTANGLE_CORNER_CYCLE_GC_INTERVAL
CORNER_CYCLE_NAMES = RECTANGLE_CORNER_CYCLE_NAMES
CORNER_CYCLE_COLORS = RECTANGLE_CORNER_CYCLE_COLORS
CORNER_CYCLE_OUTLINE_COLOR = RECTANGLE_CORNER_CYCLE_OUTLINE_COLOR
CORNER_CYCLE_ACTIVE_COLOR = RECTANGLE_CORNER_CYCLE_ACTIVE_COLOR
CORNER_CYCLE_CENTER_COLOR = RECTANGLE_CORNER_CYCLE_CENTER_COLOR
...
STEELBALL_MAX_ASPECT_RATIO = 1.35

# 钢球单目距离估计（steelball_distance.py）
# 由检测框像素直径估算距离：distance = real_diameter * focal_px / pixel_diameter。
STEELBALL_REAL_DIAMETER_CM = 1.0
STEELBALL_DISTANCE_FOCAL_X = 789.1207591978101
STEELBALL_DISTANCE_FOCAL_Y = 784.6402477892891
STEELBALL_DISTANCE_DIAMETER_MODE = "min"  # mean / min / width / height
STEELBALL_DISTANCE_CALIBRATION_SCALE = 1.0
STEELBALL_DISTANCE_MIN_PIXEL_DIAMETER = 4.0
STEELBALL_DISTANCE_USE_SMOOTHING = False
STEELBALL_DISTANCE_SMOOTH_ALPHA = 0.30
STEELBALL_DISTANCE_DEBUG_PRINT = True
STEELBALL_DISTANCE_DEBUG_RAW = True
STEELBALL_DISTANCE_TEXT_COLOR = (255, 255, 255, 255)
STEELBALL_DISTANCE_CENTER_COLOR = (255, 255, 0, 255)
STEELBALL_DISTANCE_PRINT_INTERVAL = 10
STEELBALL_DISTANCE_GC_INTERVAL = 1
...
# 数值是相对画面宽高的比例。默认全画面。
RECTANGLE_DISTANCE_ROI = (0.0, 0.0, 1.0, 1.0)

# PnP 使用的实际方框尺寸，单位 cm。
# 必须按实物外框角点对应的真实宽高修改，否则距离数值没有实际意义。
RECTANGLE_DISTANCE_OBJECT_WIDTH_CM = 29.7
RECTANGLE_DISTANCE_OBJECT_HEIGHT_CM = 21.0
...
# 方框由 detectors.rectangle.RectangleDetector 检测；PnP 优先使用 cv2.solvePnP。
# 如果当前固件没有暴露 cv2.solvePnP，则使用 square_distance.py 内置平面矩形测距。
RECTANGLE_DISTANCE_MIN_DISTANCE_CM = 0.0

RECTANGLE_DISTANCE_DRAW_ROI = True
RECTANGLE_DISTANCE_DRAW_RECTANGLE_COLOR = (0, 255, 0)
RECTANGLE_DISTANCE_DRAW_ROI_COLOR = (80, 80, 255)
RECTANGLE_DISTANCE_DRAW_POINT_COLOR = (255, 255, 0)
RECTANGLE_DISTANCE_DRAW_TEXT_COLOR = (255, 255, 255)
RECTANGLE_DISTANCE_DRAW_ERROR_COLOR = (255, 0, 0)
RECTANGLE_DISTANCE_DRAW_THICKNESS = 2
RECTANGLE_DISTANCE_DRAW_POINT_RADIUS = 5
RECTANGLE_DISTANCE_DEMO_PRINT_INTERVAL = 10
RECTANGLE_DISTANCE_DEMO_GC_INTERVAL = 30

# 历史参数别名：旧代码仍可读取 SQUARE_DISTANCE_ 前缀。
SQUARE_DISTANCE_ROI = RECTANGLE_DISTANCE_ROI
SQUARE_DISTANCE_OBJECT_WIDTH_CM = RECTANGLE_DISTANCE_OBJECT_WIDTH_CM
SQUARE_DISTANCE_OBJECT_HEIGHT_CM = RECTANGLE_DISTANCE_OBJECT_HEIGHT_CM
SQUARE_DISTANCE_CAMERA_MATRIX = RECTANGLE_DISTANCE_CAMERA_MATRIX
SQUARE_DISTANCE_DIST_COEFFS = RECTANGLE_DISTANCE_DIST_COEFFS
SQUARE_DISTANCE_MIN_DISTANCE_CM = RECTANGLE_DISTANCE_MIN_DISTANCE_CM
SQUARE_DISTANCE_DRAW_ROI = RECTANGLE_DISTANCE_DRAW_ROI
SQUARE_DISTANCE_DRAW_RECTANGLE_COLOR = RECTANGLE_DISTANCE_DRAW_RECTANGLE_COLOR
SQUARE_DISTANCE_DRAW_ROI_COLOR = RECTANGLE_DISTANCE_DRAW_ROI_COLOR
SQUARE_DISTANCE_DRAW_POINT_COLOR = RECTANGLE_DISTANCE_DRAW_POINT_COLOR
SQUARE_DISTANCE_DRAW_TEXT_COLOR = RECTANGLE_DISTANCE_DRAW_TEXT_COLOR
SQUARE_DISTANCE_DRAW_ERROR_COLOR = RECTANGLE_DISTANCE_DRAW_ERROR_COLOR
SQUARE_DISTANCE_DRAW_THICKNESS = RECTANGLE_DISTANCE_DRAW_THICKNESS
SQUARE_DISTANCE_DRAW_POINT_RADIUS = RECTANGLE_DISTANCE_DRAW_POINT_RADIUS
SQUARE_DISTANCE_DEMO_PRINT_INTERVAL = RECTANGLE_DISTANCE_DEMO_PRINT_INTERVAL
SQUARE_DISTANCE_DEMO_GC_INTERVAL = RECTANGLE_DISTANCE_DEMO_GC_INTERVAL
