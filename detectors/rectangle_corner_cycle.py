...
from config import (
    RECTANGLE_CORNER_CYCLE_ACTIVE_COLOR,
    RECTANGLE_CORNER_CYCLE_CENTER_COLOR,
    RECTANGLE_CORNER_CYCLE_COLORS,
    RECTANGLE_CORNER_CYCLE_GC_INTERVAL,
    RECTANGLE_CORNER_CYCLE_HOLD_MS,
    RECTANGLE_CORNER_CYCLE_MOVE_MS,
    RECTANGLE_CORNER_CYCLE_NAMES,
    RECTANGLE_CORNER_CYCLE_OUTLINE_COLOR,
    RECTANGLE_CORNER_CYCLE_PRINT_INTERVAL,
    RECTANGLE_CORNER_CYCLE_UART_SEND_PERIOD_MS,
    IMAGE_HEIGHT,
    IMAGE_WIDTH,
)
...
CORNER_HOLD_MS = RECTANGLE_CORNER_CYCLE_HOLD_MS
CORNER_MOVE_MS = RECTANGLE_CORNER_CYCLE_MOVE_MS
UART_SEND_PERIOD_MS = RECTANGLE_CORNER_CYCLE_UART_SEND_PERIOD_MS
PRINT_INTERVAL = RECTANGLE_CORNER_CYCLE_PRINT_INTERVAL
GC_INTERVAL = RECTANGLE_CORNER_CYCLE_GC_INTERVAL
CORNER_NAMES = RECTANGLE_CORNER_CYCLE_NAMES
CORNER_COLORS = RECTANGLE_CORNER_CYCLE_COLORS
OUTLINE_COLOR = RECTANGLE_CORNER_CYCLE_OUTLINE_COLOR
ACTIVE_COLOR = RECTANGLE_CORNER_CYCLE_ACTIVE_COLOR
CENTER_COLOR = RECTANGLE_CORNER_CYCLE_CENTER_COLOR
