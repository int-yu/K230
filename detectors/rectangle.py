...
from config import (
    ...
    RECTANGLE_TRACK_CENTER_CROSS_SIZE,
    RECTANGLE_TRACK_GC_INTERVAL,
    RECTANGLE_TRACK_PRINT_INTERVAL,
)
...
def draw_image_center(frame):
    ...
    cv2.line(
        frame,
        (IMAGE_CENTER_X - RECTANGLE_TRACK_CENTER_CROSS_SIZE, IMAGE_CENTER_Y),
        (IMAGE_CENTER_X + RECTANGLE_TRACK_CENTER_CROSS_SIZE, IMAGE_CENTER_Y),
        color,
        2,
    )
    cv2.line(
        frame,
        (IMAGE_CENTER_X, IMAGE_CENTER_Y - RECTANGLE_TRACK_CENTER_CROSS_SIZE),
        (IMAGE_CENTER_X, IMAGE_CENTER_Y + RECTANGLE_TRACK_CENTER_CROSS_SIZE),
        color,
        2,
    )
...
def run_rectangle_tracking():
    ...
    try:
        ...
        while True:
            ...
            if frame_count % RECTANGLE_TRACK_PRINT_INTERVAL == 0:
            ...
            del frame
            del image
            if frame_count % RECTANGLE_TRACK_GC_INTERVAL == 0:
                gc.collect()
